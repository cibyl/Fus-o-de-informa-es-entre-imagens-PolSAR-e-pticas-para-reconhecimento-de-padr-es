...
Nesta pesquisa é proposto a interação entre a ciência da computação e matemática aplicada. O tema escolhido conduz a interação entre as áreas potencializando suas características, 
